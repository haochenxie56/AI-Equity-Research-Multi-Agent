...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "zh": {
        ...
        # FRED 货币市场流动性（仅 Dashboard 显示，不写入快照）。
        "macro_live_grp_liquidity":        "货币市场流动性",
        "macro_live_sofr":                 "SOFR 隔夜利率 %",
        "macro_live_on_rrp":               "隔夜逆回购 ON RRP（十亿美元）",
        "macro_live_tga":                  "财政部一般账户 TGA（十亿美元）",
        "macro_live_reserves":             "银行准备金（十亿美元）",
        "macro_live_vix":                  "VIX",
    ...
    "en": {
        ...
        # FRED money-market liquidity (Dashboard display only; never in the snapshot).
        "macro_live_grp_liquidity":        "Money-market liquidity",
        "macro_live_sofr":                 "SOFR overnight rate %",
        "macro_live_on_rrp":               "ON RRP volume ($B)",
        "macro_live_tga":                  "Treasury General Account ($B)",
        "macro_live_reserves":             "Bank reserves ($B)",
        "macro_live_vix":                  "VIX",
